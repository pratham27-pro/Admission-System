...
const Payment = ({ 
  ...
  const initiatePayment = async () => {
    ...
    try {
      ...
      alert("Something went wrong with the payment process. Please try again later.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-white rounded-lg shadow-lg overflow-hidden py-16 sm:py-24">
      <div className="bg-gray-50 px-6 py-8 md:px-8">
        <h2 className="text-2xl font-bold text-center text-gray-800 mb-2">{title}</h2>
        <p className="text-center text-gray-600 mb-6">Complete your application process</p>
